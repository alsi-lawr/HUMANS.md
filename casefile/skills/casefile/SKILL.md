...
human approval, and only then pass the exact unchanged preview to
`casefile_apply_writer_binding`. Provider write capability is never that approval. If offering,
preview, or persistence fails, stop without further planning or
